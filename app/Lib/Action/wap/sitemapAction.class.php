...
public function xml(){
           ...
           $string .='<url>
<loc>http://m.baicaio.com/</loc>
<lastmod>' . date("Y-m-d") . '</lastmod>
<changefreq>always</changefreq> 
<priority>1</priority>
</url>';
        $string .='<url>
<loc>http://m.baicaio.com/topics/gny/1/</loc>
<lastmod>' . date("Y-m-d") . '</lastmod>
<changefreq>always</changefreq> 
<priority>0.9</priority>
</url>
<url>
<loc>http://m.baicaio.com/topics/gny/0/</loc>
<lastmod>' . date("Y-m-d") . '</lastmod>
<changefreq>always</changefreq> 
<priority>0.9</priority>
</url>
<url>
<loc>http://m.baicaio.com/baicai/</loc>
<lastmod>' . date("Y-m-d") . '</lastmod>
<changefreq>always</changefreq> 
<priority>0.9</priority>
</url>
<url>
<loc>http://m.baicaio.com/tag/9.9%E5%8C%85%E9%82%AE</loc>
<lastmod>' . date("Y-m-d") . '</lastmod>
<changefreq>always</changefreq> 
<priority>0.9</priority>
</url>';
        ...
        foreach ($cate_levelones as $cate_levelone) {
                if(empty($cate_levelone['cate_html'])){
                        $url = 'http://m.baicaio.com/topics/c' .  $cate_levelone['id'];
                }
                else{
                        $url = 'http://m.baicaio.com/topics/' .  $cate_levelone['cate_html'];
                }
                $string .= '<url>
<loc>' . $url . '</loc>
<lastmod>' . date("Y-m-d") . '</lastmod>
...
<priority>0.9</priority>
        ...
        foreach ($cate_leveltwos as $cate_leveltwo) {
                $url = 'http://m.baicaio.com/topics/c' .  $cate_leveltwo['id'];
                $string .= '<url>
<loc>' . $url . '</loc>
<lastmod>' . date("Y-m-d") . '</lastmod>
<changefreq>always</changefreq> 
<priority>0.8</priority>
        ...
        foreach ($cate_levelthrees as $cate_levelthree) {
                $url = 'http://m.baicaio.com/topics/c' .  $cate_levelthree['id'];
                $string .= '<url>
<loc>' . $url . '</loc>
<lastmod>' . date("Y-m-d") . '</lastmod>
<changefreq>always</changefreq> 
<priority>0.7</priority>
        ...
        foreach ($item_list as $item) {
                $url = 'http://m.baicaio.com/item/' .  $item['id'] . '.html';
                $string .= '<url>
<loc>' . $url . '</loc>
<lastmod>' . date("Y-m-d") . '</lastmod>
...
<priority>0.6</priority>
	...
	foreach ($article_list as $article) {
		$url = 'http://m.baicaio.com/article/' .  $article['id'] . '.html';
		$string .= '<url>
<loc>' . $url . '</loc>
<lastmod>' . date("Y-m-d") . '</lastmod>
<changefreq>yearly</changefreq> 
