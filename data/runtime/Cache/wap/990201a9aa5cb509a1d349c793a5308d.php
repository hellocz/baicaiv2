...
<div class="w_center">
  <div class="w_bjtjy">
   ...
   <div class="w_bjtjy_1">
    <img src="<?php echo avatar($item['uid'], 48);?>" title="<?php echo ($item["uname"]); ?>" alt="<?php echo ($item["uname"]); ?>" /><span><?php echo ($item["uname"]); ?></span>|<span><?php echo (fdate($item["add_time"])); ?></span>
   </div>
   <div class="w_bjtjy_2">
   ...
   <div class="w_bjtjy_4">
     ...
     <span class="J_fav w_bjtjy_42" data-id="<?php echo ($item["id"]); ?>" data-xid="3"><img src="/static/images/wap/w_scc.png" title="收藏" alt="收藏"/>收藏</span>
   </div>
  </div>
  <div class="w_xzzr3">
     <h3>猜您喜欢</h3>
     <ul  id="con_zk_1">
	 <?php if(is_array($maylike_list)): $i = 0; $__LIST__ = $maylike_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mval): $mod = ($i % 2 );++$i; if(is_array($mval['list'])): $i = 0; $__LIST__ = $mval['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mitem): $mod = ($i % 2 );++$i; if($mitem['num'] < 6): ?><li>
