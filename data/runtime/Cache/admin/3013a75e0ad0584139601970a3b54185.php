    ...
    <table width="100%" cellspacing="0">
        ...
        <thead>
            ...
            <tr>
                ...
                <th width="80" align="left"><span data-tdtype="order_by" data-field="coin">兑换金币</span></th>
    	...
    	<tbody>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="left"><span data-tdtype="edit" data-field="coin" data-id="<?php echo ($val["id"]); ?>" class="tdedit"><?php echo ($val["coin"]); ?></span></td>
