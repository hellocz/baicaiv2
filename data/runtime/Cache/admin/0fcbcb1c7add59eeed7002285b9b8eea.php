        ...
        <thead>
            <tr>
                ...
                <th width="80"><span data-tdtype="order_by" data-field="type"><?php echo L('item_cate_type');?></span></th>
              	<th width="90"><span data-tdtype="order_by" data-field="ordid"><?php echo L('sort_order');?></span></th>
                <th width="1"><!--<span data-tdtype="order_by" data-field="index"><?php echo L('show_index');?></span>--></th>
