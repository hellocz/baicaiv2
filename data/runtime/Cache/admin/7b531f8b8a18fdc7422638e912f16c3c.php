...
<div class="dialog_content">
	...
	<form id="info_form" name="info_form" action="<?php echo u('activity/add');?>" method="post">
	...
	<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
		...
		<tr>
			...
			<input type="text" name="dhjf" id="dhjf" class="input-text" size="30">
		...
		<tr>
			...
			<td>
				...
				<?php if(is_array($orig_list)): $i = 0; $__LIST__ = $orig_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><option value="<?php echo ($r["id"]); ?>"><?php echo ($r["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="xl" class="input-text" size="15" value="">*0不做限制
