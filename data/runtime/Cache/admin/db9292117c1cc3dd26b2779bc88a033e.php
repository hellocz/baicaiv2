	...
	<table width="100%" class="table_form">
	    ...
	    <tr>
			...
			<td>
                ...
                <img src="<?php echo avatar($info['id'], 32);?>" width="32" height="32"/>
		...
		<tr>
			...
			<td><input type="text" name="score" id="score" class="input-text" value="<?php echo ($info["score"]); ?>" size="27"></td>
		...
		<tr>
			...
			<td><input type="text" name="coin" id="coin" class="input-text" value="<?php echo ($info["coin"]); ?>" size="27"></td>
		...
		<tr>
			...
			<td><input type="text" name="offer" id="offer" class="input-text" value="<?php echo ($info["offer"]); ?>" size="27"></td>
		...
		<tr>
			...
			<td><input type="text" name="exp" id="exp" class="input-text" value="<?php echo ($info["exp"]); ?>" size="27"></td>
		...
		<tr>
			...
			<td>
				...
				<label><input type="radio" name="is_bj" value="0" <?php if($info["is_bj"] == 0): ?>checked<?php endif; ?>> 普通用户</label>&nbsp;&nbsp;

				<label><input type="radio" name="is_bj" value="1" <?php if($info["is_bj"] == 1): ?>checked<?php endif; ?>> 编辑</label>
		...
		<input type="submit" name="id" value="<?php echo ($info["id"]); ?>" />
