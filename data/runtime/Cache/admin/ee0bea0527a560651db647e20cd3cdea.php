...
<div class="pad_lr_10">
	...
	<table width="100%" class="table_form">
		...
		<tr>
            ...
            <td><input type="text" name="setting[site_url]" class="input-text" size="50" value="<?php echo C('pin_site_url');?>"></td>
        ...
        <tr>
            ...
            <td><input type="text" name="setting[quan_keywords]" class="input-text" size="50" value="<?php echo C('pin_quan_keywords');?>"></td>
        ...
        <tr>
            ...
            <td><textarea rows="9" cols="50" name="setting[seo_config]"><?php echo C('pin_seo_config');?></textarea></td>
		...
		<tr>
            ...
            <td><textarea rows="4" cols="50" name="setting[kill_ip]"><?php echo C('pin_kill_ip');?></textarea></td>
		...
		<tr>
            ...
            <td><textarea rows="4" cols="50" name="setting[kill_word]"><?php echo C('pin_kill_word');?></textarea></td>
