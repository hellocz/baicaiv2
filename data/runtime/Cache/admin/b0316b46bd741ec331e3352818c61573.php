...
<div class="dialog_content">
	...
	<table width="100%" class="table_form">
		...
		<tr>
			<th><?php echo L('item_cate_html');?> :</th>
			<td>
                <input type="text" name="cate_html" class="input-text" value="<?php echo ($info["cate_html"]); ?>">
            </td>
		</tr>
	    <tr>
			...
			<td>
			    ...
			    <?php if(!empty($info['img'])): ?><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="http://img.baicaio.com/<?php echo attach($info['img'], 'item_cate');?>"><img src="__STATIC__/images/filetype/image_s.gif" /></span><?php endif; ?>	
				</td>
		</tr>
		<tr>
