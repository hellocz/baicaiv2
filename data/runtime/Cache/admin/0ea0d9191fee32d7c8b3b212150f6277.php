...
<div class="dialog_content">
	...
	<table width="100%" class="table_form">
		...
		<th>是否主编 :</th>
			...
			<td>普通管理员<input type="radio" name="zhubian" <?php if($info['zhubian'] == 0): ?>checked<?php endif; ?> value="0">主编<input type="radio" name="zhubian" <?php if($info['zhubian'] == 1): ?>checked<?php endif; ?>  value="1"></td>
      ...
      <tr>
        ...
        <th><?php echo L('ch_amazon');?> :</th>

        <td><input type="text" name="ch_amazon" class="input-text" value="<?php echo ($info["ch_amazon"]); ?>" size="30"></td>

      </tr>

      <tr>

        <th><?php echo L('us_amazon');?> :</th>

        <td><input type="text" name="us_amazon" class="input-text" value="<?php echo ($info["us_amazon"]); ?>" size="30"></td>

      </tr>

      <tr>

        <th><?php echo L('sid');?> :</th>

        <td><input type="text" name="sid" class="input-text" value="<?php echo ($info["sid"]); ?>" size="30"></td>

      </tr>

      <tr>

        <th><?php echo L('mm_pid');?> :</th>

        <td><input type="text" name="mm_pid" class="input-text" value="<?php echo ($info["mm_pid"]); ?>" size="30"></td>
