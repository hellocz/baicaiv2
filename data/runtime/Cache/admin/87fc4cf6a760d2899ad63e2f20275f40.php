    ...
    <table width="100%" cellspacing="0">
        ...
        <thead>
            ...
            <tr>
                ...
                <th width="60" align="right"><span data-tdtype="order_by" data-field="coin">金币</span></th>

                <th width="60" align="right"><span data-tdtype="order_by" data-field="offer">贡献</span></th>

                <th width="60" align="right"><span data-tdtype="order_by" data-field="exp">经验</span></th>
    	...
    	<tbody>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><img src="<?php echo avatar($val['id'], 32);?>" width="32" height="32"/></td>
                ...
                <td align="right"><?php echo ($val["coin"]); ?></td>

                <td align="right"><?php echo ($val["offer"]); ?></td>

                <td align="right"><?php echo ($val["exp"]); ?></td>
