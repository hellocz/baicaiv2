...
<div class="w_bl_bd">
	<div class="w_zh_dq1">
	  <span <?php if($t!='e' and $k==0): ?>class="w_scdh_qd"<?php endif; ?> onclick="window.location='<?php echo U("orig/index");?>'">国内商城</span> &nbsp;&nbsp; <span <?php if($t!='e' and $k==1): ?>class="w_scdh_qd"<?php endif; ?> onclick="window.location='<?php echo U("orig/index",array('k'=>'1'));?>'">海外商城</span> &nbsp;&nbsp; <span <?php if($t=='e'): ?>class="w_scdh_qd"<?php endif; ?> onclick="window.location='<?php echo U("orig/index",array('t'=>'e'));?>'">转运公司</span> 
	</div>
  <div class="w_scdh_1">
    <div class="w_scdh_h"><?php if($t!='e'): ?><span class="w_scdh_qd" id="scdh1"  >热门商城</span><?php endif; if($t=='e'): ?><span class="w_scdh_qd"  id="scdh2" >热门转运公司</span><?php endif; ?></div>
    <div class="w_scdd_t1" id="con_scdh_1">
     <ul>
	 <?php if(is_array($hot_list)): $i = 0; $__LIST__ = $hot_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i; if($t=='e'): ?><li>
         <a href="<?php echo U('express/show',array('id'=>$item['id']));?>" title="<?php echo ($item["name"]); ?>">
           <img src="<?php echo attach($item['img'],'express');?>" title="<?php echo ($item["name"]); ?>" alt="<?php echo ($item["name"]); ?>"/><br/>
           <?php echo ($item["name"]); ?>
         </a>
       </li>
	 <?php else: ?>
       <li>
         <a href="<?php echo U('orig/show',array('id'=>$item['id']));?>" title="<?php echo ($item["name"]); ?>">
           <img src="<?php if($item['img']): echo attach($item['img'],'item_orig'); else: ?>/images/nopic.jpg<?php endif; ?>" title="<?php echo ($item["name"]); ?>" alt="<?php echo ($item["name"]); ?>"/><br/>
           <?php echo ($item["name"]); ?>
         </a>
  ...
  <div class="w_scdh_2">
  <?php if($t=='e'): ?><div class="w_scdh_h">
      <span class="w_scdh_qd"  id="scdj1" >所有转运公司</span>
      <div class="w_scdh_r">
       <em>按字母检索：</em>
       <a href="<?php echo U('orig/index',array('t'=>'e'));?>" title="全部" <?php if($p == ''): ?>class="w_rqb"<?php endif; ?>>全部</a>
	   <?php $plist = M("cosler")->select();?>
	   <?php if(is_array($plist)): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><a href="<?php echo U('orig/index',array('p'=>$r['fPY'],'t'=>'e'));?>" title="<?php echo ($r['fPY']); ?>" <?php if($p == $r['fPY']): ?>class="w_rqb"<?php endif; ?>><?php echo ($r['fPY']); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
      </div>
    </div>
    <div class="w_sc_li"  id="con_scdj_1">
      <ul>
	  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('express/show',array('id'=>$item['id']));?>" title="<?php echo ($item["name"]); ?>"><?php echo ($item["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
    </div>
  <?php else: ?>
   <div class="w_scdh_h">
      <span class="w_scdh_qd"  id="scdj1" >所有商城</span>
      <div class="w_scdh_r">
       <em>按字母检索：</em>
       <a href="<?php echo U('orig/index');?>" title="全部" <?php if($p == ''): ?>class="w_rqb"<?php endif; ?>>全部</a>
	   <?php $plist = M("cosler")->select();?>
	   <?php if(is_array($plist)): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><a href="<?php echo U('orig/index',array('p'=>$r['fPY'],'k'=>$k));?>" title="<?php echo ($r['fPY']); ?>" <?php if($p == $r['fPY']): ?>class="w_rqb"<?php endif; ?>><?php echo ($r['fPY']); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
      </div>
    </div>
    <div class="w_sc_li"  id="con_scdj_1">
      <ul>
	  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('orig/show',array('id'=>$item['id']));?>" title="<?php echo ($item["name"]); ?>"><?php echo ($item["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
    </div><?php endif; ?>
  </div>
</div>
