...
<div class="w_gezx_ce"> 
  ...
  <div class="w_ger">
	...
	<div class="w_wz">
	 ...
	 <?php  $menus = array("0"=>array('gn','国内'),'1'=>array('ht','海淘'),'2'=>array('best','精品汇'),'3'=>array('sd','晒单'),'4'=>array('gl','攻略'),'5'=>array('zr','转让')); ?>

	 <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><span <?php if($cur == $r[0]): ?>class="w_wz_h1_s"<?php endif; ?>><a href="<?php echo U('user/likes',array('t'=>$r[0]));?>" title="<?php echo ($r["1"]); ?>"><?php echo ($r["1"]); ?>（<?php echo ($num[$r[0]]); ?>）</a></span><?php endforeach; endif; else: echo "" ;endif; ?>                            

     </div>

     <div class="w_wdgl"  style="display:block;"  id="con_bl_1">
		  ...
		  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><dl  class="w_wdg_12">
            ...
            <dt class="w_wdg_12_1">
              ...
              <a href="<?php echo ($item["url"]); ?>" title="<?php echo ($item["title"]); ?>"><img src="<?php echo ($item["img"]); ?>" title="<?php echo ($item["title"]); ?>" alt="<?php echo ($item["title"]); ?>"/></a>

              <p><a href="<?php echo ($item["url"]); ?>" title="<?php echo ($item["title"]); ?>"><?php echo (msubstr($item["title"],0,26,false)); ?><br/><?php echo (msubstr($item["intro"],0,26,false)); ?></a></p>

            </dt>

            <dd  class="w_wdg_12_2"><?php echo ($item["comments"]); ?>条</dd>

            <dd  class="w_wdg_12_3"><a href="javascript:;" title="删除" class="J_like_del w_sc_a" data-url="<?php echo U('user/del_likes',array('itemid'=>$item['id'],'xid'=>$xid,'uid'=>$visitor['id']));?>">删除</a></dd>
