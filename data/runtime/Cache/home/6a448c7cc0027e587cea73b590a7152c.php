...
<div class="w_bl_bd">
  ...
  <table class="w_fbgl">
    <tr height="170px">
	  <td class="w_fbgl_1"><em>*</em>封面图片</td>
	  <td>
	     <div class="w_tp_bd">
	...
	<!--<tr height="40px">
	  ...
	  <td> &lt;!&ndash; <a href="" title="" />旅游</a> <a href="" title="" />旅游</a> <a href="" title="" />旅游</a> <a href="" title="" />旅游</a> &ndash;&gt;
        
	     <select name="cate_id" id="cate_id">
            <option value="0">选择分类</option>
			<?php $article_cate=M("article_cate")->where("pid=9")->order("id asc")->select();?>
			<?php if(is_array($article_cate)): $i = 0; $__LIST__ = $article_cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item["id"]); ?>"><?php echo ($item["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
          </select>
	...
	<!--<tr height="200px">
	  ...
	  <tr>
		  <td colspan="2"><script id="info" type="text/plain" style="width:782px;height:200px;"></script></td>
	  </tr>
      
	<tr>
	  <td colspan="2">
      <br />
	  <input type="submit" value="提交" class="w_gl_in2" />
